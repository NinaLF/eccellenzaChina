class Lexicon:
    ...
    next = "下一个"
    #Consent Text
    consent_p1 = "感谢您有兴趣参与这项研究。 <br> 这项研究将由瑞士 Basel 大学心理学系 Jessica Helm 理学硕士和 Ulf J.J. Hahnel 教授监督。"
    consent_p2 = "如果您同意参加这项研究，您将被要求执行以下操作："
    ...
    consent_bullet4 = "至少年满 18 岁"
    consent_bullet5 = "已阅读并理解所述条款，并且您有足够的时间做出决定。"
